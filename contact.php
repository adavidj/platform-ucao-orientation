    ...
    <div class="container">
        <div class="contact-grid">
            ...
            <div class="contact-form-wrapper reveal">
                ...
                <form id="contact-form" action="handlers/contact-handler.php" method="POST" data-validate>
                    <div class="form-row">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(response => {
            // Vérifier si les headers sont du JSON valide
            const contentType = response.headers.get('content-type');
            if (!contentType || !contentType.includes('application/json')) {
                console.error('Réponse invalide:', response.status, contentType);
                throw new Error(`Réponse serveur invalide (${response.status}). Vérifiez la console du serveur.`);
            }
