...
<div class="admin-card">
    <div class="admin-card-header">
        <h2 class="admin-card-title"><?= $total ?> orientation(s) trouvée(s)</h2>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;gap:4px">
                            ...
                            <a href="<?= APP_URL ?>/uploads/rapports/<?= e($o['rapport_pdf_path']) ?>" class="btn-admin btn-admin-ghost btn-admin-sm" title="Télécharger PDF" target="_blank">
